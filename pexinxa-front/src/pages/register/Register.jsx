...
export const Register = () => {
  ...
  >
        ...
        <form onSubmit={handleSubmit} className="mt-6 space-y-6">
          ...
          <div className="flex items-center">
            ...
            <label htmlFor="terms" className="ml-2 block text-sm text-gray-900">
              Li e aceito os termos de serviço e políticas de privacidade
            </label>
          </div>
          <div>
            <button
      ...
      <div className="absolute inset-0 bg-cover bg-center" style={{ backgroundImage: "./src/assets/background.svg" }}></div>
    </div>
  );
};
